...
The computational challenge is further exacerbated. 
...
%This is a consequence of the fact that galaxy properties are not input SED model parameters but rather derived quantities (see Appendix of \citealt{hahn2022}).
...
%For MCMC-based methods, posteriors would need to be re-evaluated from scratch for each prior.
