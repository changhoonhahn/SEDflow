...
of galaxy SEDs.
The task of SED modeling alone for these surveys would amount to tens or hundreds of billions of CPU hours, exceeding e.g. the compute allocation of the entire LSST data processing \peter{by at least two orders of magnitude.
Runtimes of hours per galaxy also entirely preclude analyses with fast turnaround requirements, 
in particular for the upcoming transient surveys [cite LSST and HATPI].}

%There are even more computational challenges.
