...
Since each evaluation takes \chedit{X} seconds, it takes >\chedit{Y} hours for
...
\chedit{Z} seconds to evaluate, $100\times$ faster than the original model. 
Yet, even with emulators, due to the number of evaluations necessary for
convergence, an MCMC posterior takes >\chedit{ZZ} hours. 
