...
redshifts   = np.random.uniform(1., 2., Nsample) 
...
np.savez_compressed(os.path.join(dat_dir, 'modelc', 'train_sed.modelc.%i.thetas_sps.npz' % seed), thetas_sps)
np.savez_compressed(os.path.join(dat_dir, 'modelc', 'train_sed.modelc.%i.thetas_unt.npz' % seed), thetas_unt)
np.savez_compressed(os.path.join(dat_dir, 'modelc', 'train_sed.modelc.%i.redshifts.npz' % seed), redshifts)
np.savez_compressed(os.path.join(dat_dir, 'modelc', 'train_sed.modelc.%i.waves.npz' % seed), waves)
np.savez_compressed(os.path.join(dat_dir, 'modelc', 'train_sed.modelc.%i.seds.npz' % seed), seds)
